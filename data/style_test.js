const style = {
    ...
    "sources": {
        ...
        "composite": {
            "type": "vector",
            "tiles": [location.origin+location.pathname+"stl_tiles/{z}/{x}/{y}.pbf"
            ]
        }
    },
